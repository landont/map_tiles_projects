...
// Default UART configuration - can be overridden with gps_init_with_config()
#define GPS_UART_NUM            UART_NUM_2
#define GPS_UART_TX_PIN         (17)   // Default TX pin
#define GPS_UART_RX_PIN         (18)   // Default RX pin
